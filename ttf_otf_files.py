...
ttf_otf_files = [
    ...
    TtfOtf(
        path=os.path.join(
            ...
            "GeistMono",
            "ttf",
            "GeistMono-ExtraLightItalic.ttf",
        ),
        enable_stylistic_sets=True,
        stylistic_sets="ss01,ss06,ss08",
    ),
